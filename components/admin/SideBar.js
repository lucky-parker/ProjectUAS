            ...
            <div className="row flex-nowrap">
                ...
                <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <li>
                        ...
                        <li className="w-100">
                            <Link href="/admin/datapengunjung">
                            <a href="#" className="nav-link px-0"> <span className="d-none d-sm-inline"></span> Data Pengunjung</a>
                            </Link>
                        </li>
                        <li>
                            <Link href="/admin/createpengunjung">
                            <a href="#" className="nav-link px-0"> <span className="d-none d-sm-inline"></span> Tambah Pengunjung</a>
                            </Link>
                        </li>
                        </ul>
                    </li>
